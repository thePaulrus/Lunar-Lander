...
bgfx::VertexLayout VertexFormat_Pos3UV::format;
bgfx::VertexLayout VertexFormat_Pos3UV_Normal::format;

void InitVertexFormats()
{
    VertexFormat_PosColor::InitVertexLayout();
    VertexFormat_PosUV::InitVertexLayout();
    VertexFormat_Pos3UV::InitVertexLayout();
    VertexFormat_Pos3UV_Normal::InitVertexLayout();
}
